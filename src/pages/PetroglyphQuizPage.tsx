...
const results = {
  goat: {
    ...
    why:
      'Этот образ хорошо сочетается с мотивами горных животных и охотничьих сцен, которые упоминаются для кыргызских комплексов.',
  ...
  deer: {
    ...
    why:
      'Чолпон-Ата хорошо подходит для первого живого знакомства с петроглифами и образами животных.',
  ...
  hunter: {
    ...
    recommendation: 'Тебе стоит посмотреть Чолпон-Ата.',
    why:
      'Там особенно хорошо считываются сцены охоты и динамичные человеческие образы.',
    placeTag: 'Cholpon-Ata',
  },
  rider: {
    title: 'Ты — Всадник',
    ...
    recommendation: 'Тебе стоит посмотреть Чолпон-Ата.',
    why:
      'Этот комплекс хорошо подходит под архетип движения, человека и пути.',
    placeTag: 'Cholpon-Ata',
  },
  sun: {
    ...
    recommendation: 'Тебе стоит посмотреть Чолпон-Ата.',
    why:
      'Там особенно уместно искать символические мотивы и круговые знаки.',
    placeTag: 'Cholpon-Ata',
  },
  ritual: {
    ...
    recommendation: 'Тебе стоит посмотреть Беш-Таш-Короо.',
    why:
      'Этот архетип хорошо сочетается с ритуальными и человеческими образами.',
    placeTag: 'Besh-Tash-Koroo',
  },
} satisfies Record<
  Archetype,
      ...
      {isLoading ? (
        ...
        <div className="mx-auto max-w-4xl glow-card panel-ornament rounded-3xl p-6">
          <div className="rounded-3xl border border-amber-400/20 bg-gradient-to-br from-amber-500/15 to-orange-500/10 p-6">
            ...
            <p className="mt-2 text-lg text-amber-100">{result.subtitle}</p>
          </div>

          <div className="mt-6 grid gap-4 lg:grid-cols-2">
            <div className="rounded-3xl border border-white/10 bg-black/20 p-5">
              <h3 className="text-lg font-bold text-white">Характер</h3>
            ...
            <div className="rounded-3xl border border-emerald-400/20 bg-emerald-500/10 p-5">
              <h3 className="text-lg font-bold text-white">Куда пойти</h3>
          ...
          <button
            onClick={restart}
            className="mt-6 rounded-2xl border border-white/10 bg-white/5 px-5 py-3 font-semibold text-white transition hover:bg-white/10"
          >
            Пройти ещё раз
          </button>
        </div>
