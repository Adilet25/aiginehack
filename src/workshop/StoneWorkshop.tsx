...
const templatePaths: Record<Exclude<TemplateType, 'none'>, string> = {
  ...
  hunter: 'M210 120 L220 155 L215 190 M220 155 L260 150 M260 150 L300 115 M260 150 L300 185 M215 190 L195 240 M215 190 L235 240 M300 115 C330 120, 355 135, 380 155',
}
...
const confidenceStyles = {
  ...
  high: 'border-emerald-400/20 bg-emerald-500/10 text-emerald-100',
}
...
export default function StoneWorkshop() {
  ...
  const [impactPulse, setImpactPulse] = useState<{ x: number; y: number } | null>(null)
  ...
  const drawStoneBackground = (
    ...
    for (let i = 0; i < 10; i++) {
      ...
      ctx.beginPath()
      ctx.moveTo(0, y)
      ctx.bezierCurveTo(width * 0.25, y + 10, width * 0.6, y - 10, width, y + 5)
      ctx.stroke()
    }
  }
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="space-y-4">
          <div className="glow-card panel-ornament rounded-3xl p-5">
            <h3 className="text-xl font-bold text-white">Режим резьбы по камню</h3>
          ...
          <div className="glow-card panel-ornament rounded-3xl p-5">
            <h4 className="text-lg font-bold text-white">Инструменты</h4>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/50">Грубые удары по камню</div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/50">Точные насечки и форма</div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/50">Лёгкая проработка линий</div>
                  </div>
                </div>
              </button>
            </div>
          ...
          <div className="glow-card panel-ornament rounded-3xl p-5">
            <h4 className="text-lg font-bold text-white">Шаблон</h4>
          ...
          <div className="glow-card panel-ornament rounded-3xl p-5">
            <h4 className="text-lg font-bold text-white">Действия</h4>
            ...
            <div className="mt-4 grid gap-3">
              ...
              <button
                onClick={clearCanvas}
                className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white transition hover:bg-white/10"
              >
                <RotateCcw size={18} />
                Очистить камень
              </button>
              ...
              <button
                onClick={saveImage}
                className="flex items-center gap-3 rounded-2xl border border-emerald-400/20 bg-emerald-500/10 px-4 py-3 text-emerald-100 transition hover:bg-emerald-500/20"
              >
                <Download size={18} />
                Сохранить петроглиф
              </button>
        ...
        <div className="glow-card panel-ornament rounded-3xl p-5">
          ...
          <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-sm leading-7 text-white/65">
            Совет: начни с шаблона, выбери <b className="text-white">молоток</b> для грубой формы,
            потом пройди <b className="text-white">зубилом</b> по линиям, а в конце используй
            <b className="text-white"> мягкий инструмент</b> для деталей.
          </div>
        </div>
      </div>
        ...
        <>
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <div className="glow-card panel-ornament rounded-3xl p-6">
              ...
              <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-4 text-sm leading-7 text-white/60">
                Это предварительная интерпретация для MVP. Она основана на выбранном шаблоне
                или простой визуальной эвристике.
              </div>
            </div>
          </div>
          ...
          <div className="glow-card panel-ornament rounded-3xl p-6">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <div className="rounded-2xl border border-amber-400/20 bg-amber-500/10 px-4 py-3 text-sm text-amber-100">
                1 место: шанс на физическое воплощение и процент от продажи по правилам конкурса
              </div>
            </div>
